...
const EmployeeRegistration = () => {
  ...
  const storedUsername = localStorage.getItem('employeeName'); // Replace 'username' with your localStorage key
  if (storedUsername) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!validateForm()) {
      toast.error('Please ensure all required fields are filled out correctly.');
      return;
    }
    ...
    <div className="max-w-full mx-auto px-6 rounded shadow-md">
      ...
      <div className="flex justify-between items-center">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-2 mb-4">See all details at one place.</p>
        </div>
      ...
      >
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="placeholder-lightGray w-full border border-[#36BCBA] rounded bg-transparent px-4 py-2 outline-none text-[#36BCBA]"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="placeholder-lightGray w-full border border-[#36BCBA] bg-transparent text-[#36BCBA] rounded px-4 py-2 outline-none"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
          <div>
            ...
            {errors.role_company && <p className="text-red-500 text-sm mt-1">{errors.role_company}</p>}
          </div>
        </div>
